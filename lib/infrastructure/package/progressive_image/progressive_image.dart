// ignore_for_file: no_leading_underscores_for_local_identifiers, library_private_types_in_public_api, constant_identifier_names
  ...
  void initState() {
    ...
    ImageStreamListener _thumbnailListener =
      ...
      if (_status != Progress.TargetLoaded) {
        ...
        widget.image.resolve(const ImageConfiguration()).addListener(_targetListener);
      }
    });
